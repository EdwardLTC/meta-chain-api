...
var CollectionsListener_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CollectionsListener = void 0;
...
const tokens_listener_1 = require("../tokens/tokens.listener");
let CollectionsListener = CollectionsListener_1 = class CollectionsListener {
    contracts;
    prisma;
    tokenListenerService;
    logger = new common_1.Logger(CollectionsListener_1.name);
    contract;
...
exports.CollectionsListener = CollectionsListener;
exports.CollectionsListener = CollectionsListener = CollectionsListener_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(2, (0, common_1.Inject)((0, common_1.forwardRef)(() => tokens_listener_1.TokensListener))),
    __metadata("design:paramtypes", [contracts_service_1.ContractsService,
        prisma_service_1.PrismaService,
        tokens_listener_1.TokensListener])
], CollectionsListener);
//# sourceMappingURL=collections.listener.js.map